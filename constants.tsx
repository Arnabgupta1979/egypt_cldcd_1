    ...
    options: [
      ...
      { id: 'rights', label: { en: 'Understand my rights as a farmer', ar: 'فهم حقوقي كمزارع' },
        result: {
          ...
          procedure: { en: ['Identify the variety and verify its protection status on the EGIPA plant variety register (protected vs. public).', 'If the variety is public/unprotected (e.g., Giza 168, Sakha 95), no further action is required — saving and replanting are free.', 'If protected under Law 82/2002, limit saved seed to own-farm, non-commercial replanting only.', 'Never offer saved seed of protected varieties for sale, exchange, or onward distribution.', 'For conditions beyond "reasonable limits", contact the breeder or EGIPA for a written authorisation.', 'Retain purchase invoices and tags as evidence of lawful origin in case of dispute.'], ar: ['حدد الصنف وتحقق من حالة حمايته في سجل الأصناف النباتية لدى الجهاز المصري للملكية الفكرية (EGIPA) (محمي أم عام).', 'إذا كان الصنف عاماً/غير محمي (كجيزة 168 أو سخا 95)، فلا حاجة لأي إجراء إضافي.', 'إذا كان محمياً بموجب القانون 82/2002، اقتصر استخدام البذور المحتفظ بها على إعادة الزراعة الخاصة وغير التجارية.', 'لا تعرض بذور الأصناف المحمية للبيع أو التبادل أو التوزيع.', 'في حالات تتجاوز "الحدود المعقولة"، تواصل مع المربي أو EGIPA للحصول على إذن خطي.', 'احتفظ بفواتير الشراء والعلامات كدليل على المصدر القانوني عند أي نزاع.'] },
          authorityIds: ['pvpo'],
    ...
    options: [
      ...
      { id: 'potato', label: { en: 'Potato', ar: 'بطاطس' },
        result: {
          ...
          keyPoints: { en: ['Only CASC-registered potato varieties are legal for commercial planting', 'Grades: Elite or EU EEC2 — no lower class allowed', 'Imports obey strict seasonal windows set annually and published in the Official Gazette'], ar: ['أصناف البطاطس المسجلة في CASC فقط قانونية للزراعة التجارية', 'الدرجات: Elite أو EU EEC2 — لا يُسمح بدرجة أدنى', 'يخضع الاستيراد لنوافذ موسمية صارمة تُحدَّد سنوياً وتُنشر في الجريدة الرسمية'] },
    ...
    options: [
      ...
      { id: 'maize_var', label: { en: 'Maize', ar: 'ذرة' },
        result: {
          ...
          procedure: { en: [
            ...
            'Step 5 — VCU testing: 2 years (expedited for maize) across multiple agro-ecological zones, compared to commercial check varieties for yield, disease resistance, and quality.',
            'Step 6 — The Variety Registration Committee (VRC) reviews the results and recommends grant.',
            ...
            'الخطوة 5 — اختبار VCU: سنتان (مسار مختصر للذرة) عبر مناطق بيئية-زراعية متعددة ومقارنة مع الأصناف المرجعية.',
            'الخطوة 6 — تراجع لجنة تسجيل الأصناف (VRC) النتائج وتوصي بالمنح.',
      ...
      { id: 'field_var', label: { en: 'Other field crops (wheat, cotton, rice, etc.)', ar: 'محاصيل حقلية أخرى (قمح، قطن، أرز، إلخ)' },
        result: {
          ...
          keyPoints: { en: ['Full cycle is 4–5 years: 3 years VCU plus DUS in parallel', 'VRC evaluates; EGIPA administers the Register (since March 2025)', 'Protection lasts 20 years (25 years for trees and vines)'], ar: ['الدورة الكاملة 4-5 سنوات: 3 سنوات VCU مع DUS بالتوازي', 'لجنة تسجيل الأصناف (VRC) تقيّم والجهاز المصري للملكية الفكرية (EGIPA) يدير السجل (منذ مارس 2025)', 'الحماية لمدة 20 سنة (25 سنة للأشجار والكروم)'] },
          procedure: { en: [
            'Step 1 — All procedures must be completed through a licensed Egyptian agent or a registered branch of the foreign company. All documents must be in Arabic, except the authorisation letter and the DUS report.',
            'Step 2 — Submit the official application form to the Technical Secretariat of the Seed Registration Committee at CASC.',
    ...
    options: [
      { id: 'company_pvp', label: { en: 'Company (capital > EGP 50,000)', ar: 'شركة (رأس مال > 50,000 جنيه)' },
        result: {
          ...
          keyPoints: { en: ['Fees (filing, certificate, opposition, annual maintenance) are set by EGIPA\'s current schedule, revised October 2025 — confirm current amounts with EGIPA', 'Group A applies to companies with capital exceeding EGP 50,000', 'Protection period: 20 years (25 years for trees and vines)'], ar: ['تُحدَّد الرسوم (تقديم، شهادة، اعتراض، صيانة سنوية) وفق جدول الرسوم الحالي للجهاز المصري للملكية الفكرية (EGIPA)، المُحدَّث في أكتوبر 2025 — تأكّد من القيم الحالية مع EGIPA', 'تنطبق المجموعة أ على الشركات التي يتجاوز رأس مالها 50,000 جنيه', 'مدة الحماية: 20 سنة (25 سنة للأشجار والكروم)'] },
          procedure: { en: ['Step 1 — File Application: submit the prescribed form to EGIPA (the Egyptian Intellectual Property Authority, which has administered plant variety protection since March 2025) with the applicable filing fee.', 'Step 2 — Submit Documentation: technical statement, NGB deposit certificate, and authenticated copies of foreign applications with Arabic translation (items 3–5 may follow within 4 months).', 'Step 3 — Application Processing: EGIPA assigns a serial number and records the variety in the Register of Plant Varieties.', 'Step 4 — DUS Examination per Article 192 and UPOV Test Guidelines (conducted by CASC on behalf of EGIPA).', 'Step 5 — Publication of acceptance in the monthly gazette; 60-day opposition window.', 'Step 6 — Ministerial grant published in the "Egyptian Gazette of Protected Plant Varieties"; pay the applicable certificate fee.', 'Step 7 — Pay the annual maintenance fee to keep rights in force for 20 or 25 years. All fees follow EGIPA\'s current schedule (revised October 2025) — confirm amounts with EGIPA.'], ar: ['الخطوة 1 — تقديم الطلب: قدّم النموذج المعتمد إلى الجهاز المصري للملكية الفكرية (EGIPA)، الذي يتولى حماية الأصناف النباتية منذ مارس 2025، مع سداد رسم التقديم المقرر.', 'الخطوة 2 — تقديم الوثائق: بيان تقني، شهادة إيداع NGB، ونسخ مصدّقة من الطلبات الأجنبية بترجمة عربية (يجوز استكمالها خلال 4 أشهر).', 'الخطوة 3 — معالجة الطلب: يمنح EGIPA رقماً مسلسلاً ويقيد الصنف في سجل الأصناف النباتية.', 'الخطوة 4 — فحص DUS وفق المادة 192 وإرشادات UPOV (تُجريه CASC نيابة عن EGIPA).', 'الخطوة 5 — نشر القبول في الجريدة الشهرية وفترة اعتراض 60 يوماً.', 'الخطوة 6 — المنح الوزاري ونشره في "الجريدة المصرية للأصناف النباتية المحمية"؛ وسداد رسم الشهادة المقرر.', 'الخطوة 7 — سداد رسم الصيانة السنوي للحفاظ على الحماية 20 أو 25 سنة. تتبع جميع الرسوم جدول EGIPA الحالي (المُحدَّث في أكتوبر 2025) — تأكّد من القيم مع EGIPA.'] },
          authorityIds: ['pvpo'],
          documentIds: ['law-82-2002'],
        }
      },
      { id: 'individual_pvp', label: { en: 'Individual, institution, or small entity', ar: 'فرد أو مؤسسة أو كيان صغير' },
        result: {
          ...
          keyPoints: { en: ['Fees are set by EGIPA\'s current schedule (revised October 2025) — confirm current amounts with EGIPA', 'Same 7-step registration path as Group A', 'Same 20/25-year protection from the grant date'], ar: ['تُحدَّد الرسوم وفق جدول الجهاز المصري للملكية الفكرية (EGIPA) الحالي (المُحدَّث في أكتوبر 2025) — تأكّد من القيم الحالية مع EGIPA', 'نفس مسار التسجيل من 7 خطوات كالمجموعة أ', 'نفس مدة الحماية 20/25 سنة من تاريخ المنح'] },
          procedure: { en: ['Step 1 — File Application at EGIPA (which has administered plant variety protection since March 2025) with the applicable filing fee; include proof of applicant status (individual, institution, or small entity).', 'Step 2 — Submit Documentation: technical statement, NGB deposit certificate, and Arabic-translated foreign-application copies (items 3–5 deferrable by 4 months).', 'Step 3 — Processing: EGIPA records the variety in the Register and issues a serial number.', 'Step 4 — DUS examination against UPOV Test Guidelines (conducted by CASC on behalf of EGIPA).', 'Step 5 — Publication in the gazette triggers a 60-day opposition period.', 'Step 6 — Ministerial grant; pay the applicable certificate delivery fee.', 'Step 7 — Maintain the right by paying the annual fee throughout the 20- or 25-year protection window. All fees follow EGIPA\'s current schedule (revised October 2025) — confirm amounts with EGIPA.'], ar: ['الخطوة 1 — تقديم الطلب إلى الجهاز المصري للملكية الفكرية (EGIPA)، الذي يتولى حماية الأصناف النباتية منذ مارس 2025، مع سداد رسم التقديم المقرر؛ وإرفاق إثبات صفة المتقدم (فرد أو مؤسسة أو كيان صغير).', 'الخطوة 2 — إرفاق الوثائق: بيان تقني، شهادة إيداع NGB، ونسخ الطلبات الأجنبية مترجمة (يجوز التأجيل 4 أشهر).', 'الخطوة 3 — المعالجة: يسجل EGIPA الصنف ويمنح رقماً مسلسلاً.', 'الخطوة 4 — فحص DUS وفق إرشادات UPOV (تُجريه CASC نيابة عن EGIPA).', 'الخطوة 5 — النشر في الجريدة يفتح فترة اعتراض 60 يوماً.', 'الخطوة 6 — المنح الوزاري؛ وسداد رسم تسليم الشهادة المقرر.', 'الخطوة 7 — الحفاظ على الحق بسداد الرسم السنوي طوال نافذة الحماية 20 أو 25 سنة. تتبع جميع الرسوم جدول EGIPA الحالي (المُحدَّث في أكتوبر 2025) — تأكّد من القيم مع EGIPA.'] },
          authorityIds: ['pvpo'],
          documentIds: ['law-82-2002'],
        }
      },
...
export const MOCK_DOCS: Document[] = [
  ...
  {
    id: 'law-82-2002',
    title: { ar: 'قانون حماية حقوق الملكية الفكرية رقم 82 لسنة 2002 (وتعديلاته بالقانونين 26 لسنة 2015 و144 لسنة 2019)', en: 'Intellectual Property Rights Protection Law No. 82 of 2002 (as amended by Laws 26/2015 and 144/2019)' },
    type: 'Law',
    authority: 'MALR / EGIPA',
    hierarchy: 'Primary Legislation',
    refNumber: '82/2002',
    issueDate: '2002-06-03',
    effectiveDate: '2002-06-03',
    language: 'Arabic',
    version: 'As amended (2015, 2019)',
    status: DocStatus.IN_FORCE,
...
export const MOCK_AUTHORITIES: Authority[] = [
  {
    id: 'casc',
    name: { ar: 'الإدارة المركزية لاعتماد التقاوي (CASC)', en: 'Central Administration for Seed Testing and Certification (CASC)' },
    shortName: 'CASC',
  ...
  {
    id: 'pvpo',
    name: { ar: 'حماية الأصناف النباتية — الجهاز المصري للملكية الفكرية (EGIPA)', en: 'Plant Variety Protection — Egyptian Intellectual Property Authority (EGIPA)' },
    shortName: 'EGIPA',
