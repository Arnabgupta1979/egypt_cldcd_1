    ...
    options: [
      ...
      { id: 'individual_pvp', label: { en: 'Individual, institution, or small entity', ar: 'فرد أو مؤسسة أو كيان صغير' },
        result: {
          ...
          procedure: { en: ['Step 1 — File Application at EGIPA (which has administered plant variety protection since March 2025) with EGP 25 filing fee; include proof of applicant status (individual, institution, or small entity).', 'Step 2 — Submit Documentation: technical statement, NGB deposit certificate, and Arabic-translated foreign-application copies (items 3–5 deferrable by 4 months).', 'Step 3 — Processing: EGIPA records the variety in the Register and issues a serial number.', 'Step 4 — DUS examination against UPOV Test Guidelines (conducted by CASC on behalf of EGIPA).', 'Step 5 — Publication in the gazette triggers a 60-day opposition period.', 'Step 6 — Ministerial grant; pay EGP 100 certificate delivery fee.', 'Step 7 — Maintain the right by paying annual fees (up to EGP 2,000) throughout the 20- or 25-year protection window.'], ar: ['الخطوة 1 — تقديم الطلب إلى الجهاز المصري للملكية الفكرية (EGIPA)، الذي يتولى حماية الأصناف النباتية منذ مارس 2025، برسم 25 جنيه؛ وإرفاق إثبات صفة المتقدم (فرد أو مؤسسة أو كيان صغير).', 'الخطوة 2 — إرفاق الوثائق: بيان تقني، شهادة إيداع NGB، ونسخ الطلبات الأجنبية مترجمة (يجوز التأجيل 4 أشهر).', 'الخطوة 3 — المعالجة: يسجل EGIPA الصنف ويمنح رقماً مسلسلاً.', 'الخطوة 4 — فحص DUS وفق إرشادات UPOV (تُجريه CASC نيابة عن EGIPA).', 'الخطوة 5 — النشر في الجريدة يفتح فترة اعتراض 60 يوماً.', 'الخطوة 6 — المنح الوزاري؛ ودفع رسم تسليم الشهادة 100 جنيه.', 'الخطوة 7 — الحفاظ على الحق بسداد الرسوم السنوية (حتى 2,000 جنيه) طوال نافذة الحماية 20 أو 25 سنة.'] },
          authorityIds: ['pvpo'],
          documentIds: ['law-82-2002'],
        }
      },
